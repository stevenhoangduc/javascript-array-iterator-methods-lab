...
// let sortedByBirthYear = [birthYears.filter((birthYear) => {
//     return birthYear.year >= 1500 && birthYear.year < 1600;
//   })];
...
function checkAge(dev) {
    return dev.year < 2005
}
isEveryone19OrOlder = devs.every(checkAge)
